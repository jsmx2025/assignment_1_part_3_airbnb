class AvailabilitiesController < ApplicationController
  def index
    ...
    @availabilities = @q.result(:distinct => true).includes(:listing, :price).page(params[:page]).per(10)
  ...
  def create
    ...
    @availability.listing_id = params[:listing_id]
    @availability.dates_available = params[:dates_available]
